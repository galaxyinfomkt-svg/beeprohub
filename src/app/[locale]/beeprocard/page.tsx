    ...
    <>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-rose-900/80 via-pink-800/60 to-primary/40" />
        </div>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 lg:py-24 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-left">
              ...
              <p className="text-gray-200 text-base lg:text-lg leading-relaxed mb-6">{t("subtitle")}</p>
