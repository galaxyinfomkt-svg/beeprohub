          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="space-y-5">
              ...
              <div className="bg-gradient-to-br from-gold-50 to-amber-50 rounded-2xl p-7 border-2 border-primary/10">
                ...
                <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="btn-primary btn-shine w-full text-center justify-center animate-pulse-yellow">{t("cta.onlineCta")} &rarr;</a>
              </div>
            </div>
          </div>
        </div>
