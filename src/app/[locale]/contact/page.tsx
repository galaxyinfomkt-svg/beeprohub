    ...
    <>
      ...
      <section className="bg-primary-light py-12">
        <div className="max-w-2xl mx-auto px-4 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-dark leading-tight mb-4">{t("title")}</h1>
          <p className="text-base text-gray-500 leading-relaxed">{t("subtitle")}</p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="space-y-5">
              ...
              <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 bg-gray-50 p-6 rounded-2xl border border-gray-100 hover:border-green-300 transition-all">
                ...
                <div><p className="font-bold text-dark">WhatsApp</p><p className="text-sm text-gray-500">Fale conosco agora</p></div>
              </a>
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
              ...
              <div className="bg-dark rounded-2xl p-7">
                <h3 className="text-primary font-bold text-xl mb-3">{t("cta.title")}</h3>
                ...
                <a href={PHONE_LINK} className="block text-center bg-primary hover:bg-primary-hover text-dark font-bold py-3 rounded-xl transition-all">{t("cta.callCta")}</a>
              </div>
            </div>
          </div>
        </div>
