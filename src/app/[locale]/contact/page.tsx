      ...
      <section className="section-padding bg-white">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div className="animate-fade-in-left"><ContactForm /></div>
            <div className="animate-fade-in-right flex flex-col gap-5">
              ...
              <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="glass-card p-6 flex items-center gap-4 cursor-pointer">
              ...
              <div className="bg-gradient-to-br from-dark to-dark-light rounded-2xl p-7 text-white">
                ...
                <a href={PHONE_LINK} className="block text-center bg-gradient-to-r from-primary to-primary-hover text-dark font-bold py-3.5 rounded-xl">{t("cta.callCta")}</a>
              </div>
            </div>
          </div>
        </div>
