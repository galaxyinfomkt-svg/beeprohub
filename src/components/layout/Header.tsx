...
import { PHONE, PHONE_LINK, WHATSAPP_LINK, LOGIN_URL } from "@/lib/utils";
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-[999] bg-white flex flex-col pt-20 overflow-y-auto">
          ...
          <div className="p-6 flex flex-col gap-4 mt-auto border-t border-gray-100">
            ...
            <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" onClick={() => setMobileOpen(false)} className="flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold text-lg py-3 rounded-xl">
